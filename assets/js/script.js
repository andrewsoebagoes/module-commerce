  ...
  $("form[name='transaction_form']").validate({
    ...
    errorPlacement: function (error, element) {
      ...
      if (element.is('select')) {
        element.addClass('is-invalid'); // Tambahkan kelas is-invalid ke elemen select
      } else if (element.is('input')) {
        element.addClass('is-invalid'); // Tambahkan kelas is-invalid ke elemen input
      }
    },
...
function tambahData(id_product, product_name, price, sku) {
  // console.log('Memanggil tambahData:', id_product, product_name, price, sku);
  // var tambah_data = '<tr><td><input type="text" name="id_product[]" hidden="" value="'+ id_product +'"><span class="nama-barang-td">'+ product_name +'</span><span class="id-barang-td">'+ id_product +'</span></td><td><input type="text" name="price[]" hidden="" value="'+ price +'"><span>Rp. '+ parseInt(price).toLocaleString() +'</span></td><td><div class="d-flex justify-content-start align-items-center"><input type="text" name="jumlah_barang[]" hidden="" value="1"><a href="#" class="btn-operate mr-2 btn-tambah"><i class="mdi mdi-plus"></i></a><span class="ammount-product mr-2" unselectable="on" onselectstart="return false;" onmousedown="return false;"><p class="jumlah_barang_text">1</p></span><a href="#" class="btn-operate btn-kurang"><i class="mdi mdi-minus"></i></a></div></td><td><input type="text" class="total_barang" name="total_barang[]" hidden="" value="'+ price +'"><span>Rp. '+ parseInt(price).toLocaleString() +'</span></td><td><a href="#" class="btn btn-outline-danger ml-1 btn-hapus"><i class="mdi mdi-close"></i></a></td><td hidden=""><span>'+ sku +'</span></td></tr>';
  var tambah_data = '<tr><td><input type="text" name="id_product[]" hidden="" value="' + id_product + '"><span class="nama-barang-td">' + product_name + '</span><span class="id-barang-td">' + id_product + '</span></td><td><input type="text" name="price[]" hidden="" value="' + price + '"><span>Rp. ' + parseInt(price).toLocaleString() + '</span></td><td><div class="d-flex justify-content-start align-items-center"><input type="text" name="jumlah_barang[]" hidden="" value="1"><a href="#" class="btn-operate mr-2 btn-kurang"><i class="mdi mdi-minus"></i></a><span class="ammount-product mr-2" unselectable="on" onselectstart="return false;" onmousedown="return false;"><p class="jumlah_barang_text">1</p></span><a href="#" class="btn-operate btn-tambah"><i class="mdi mdi-plus"></i></a></div></td><td><input type="text" class="total_barang" name="total_barang[]" hidden="" value="' + price + '"><span>Rp. ' + parseInt(price).toLocaleString() + '</span></td><td><a href="#" class="btn btn-outline-danger ml-1 btn-hapus"><i class="mdi mdi-close"></i></a></td><td hidden=""><span>' + sku + '</span></td></tr>';
...
$(document).on('click', '.btn-tambah', function (e) {
  ...
  if (stok > jumlah_barang) {
    ...
    $(this).prev().children().first().html(tambah_barang);
...
$(document).on('click', '.btn-kurang', function (e) {
  ...
  if (jumlah_barang > 1) {
    ...
    $(this).prev().val(kurang_barang);
    $(this).next().children().first().html(kurang_barang);
...
$(document).ready(function () {
  $('input[name=search]').on('keyup', function () {
    ...
    $(".product-list .produk").each(function () {
