...
function tambahData(id_product, product_name, final_price, sku) {
  // console.log('Memanggil tambahData:', id_product, product_name, final_price, sku);
  // var tambah_data = '<tr><td><input type="text" name="id_product[]" hidden="" value="'+ id_product +'"><span class="nama-barang-td">'+ product_name +'</span><span class="id-barang-td">'+ id_product +'</span></td><td><input type="text" name="final_price[]" hidden="" value="'+ final_price +'"><span>Rp. '+ parseInt(final_price).toLocaleString() +'</span></td><td><div class="d-flex justify-content-start align-items-center"><input type="text" name="jumlah_barang[]" hidden="" value="1"><a href="#" class="btn-operate mr-2 btn-tambah"><i class="mdi mdi-plus"></i></a><span class="ammount-product mr-2" unselectable="on" onselectstart="return false;" onmousedown="return false;"><p class="jumlah_barang_text">1</p></span><a href="#" class="btn-operate btn-kurang"><i class="mdi mdi-minus"></i></a></div></td><td><input type="text" class="total_barang" name="total_barang[]" hidden="" value="'+ final_price +'"><span>Rp. '+ parseInt(final_price).toLocaleString() +'</span></td><td><a href="#" class="btn btn-outline-danger ml-1 btn-hapus"><i class="mdi mdi-close"></i></a></td><td hidden=""><span>'+ sku +'</span></td></tr>';
