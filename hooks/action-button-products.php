...
return '
        <a href="'.routeTo('crud/index',['table'=>'product_prices','filter'=>['product_id' => $data->id]]).'" class="btn btn-sm btn-success"><i class="fas fa-cog"></i> '.__('commerce.label.price_setting').'</a> 
